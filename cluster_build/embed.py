...
if __name__ == "__main__":
    ...
    # dataset = datasets.load_from_disk("data/test_decode_fineweb") ## TODO change input dataset
    dataset = datasets.concatenate_datasets(
        [datasets.load_from_disk(f"/data/datasets/hf_cache/data/fineweb/sample-350BT/train_decode/0/{i}") for i in range(16)]
    )
    # dataset = dataset[:1000] # testing
    ...
    # output_dir = f"data/embeddings" ## TODO change output dir
    output_dir = "/data/datasets/hf_cache/data/fineweb/sample-350BT/train_bge_micro_embeddings"
