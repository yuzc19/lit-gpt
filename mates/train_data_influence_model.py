...
if __name__ == "__main__":
    ...
    parser.add_argument("--data", type=str, default="/data/datasets/hf_cache/out/pythia-1b/step143000/fineweb/final/oracle_full", required=False)

    args = parser.parse_args()
    print(args)

    if args.data:
        train_dataset, eval_dataset = load_datasets_tar(args.data)
    else:
        train_dataset, eval_dataset = load_datasets_tar(f"out/step-{args.ckpt}/pythia-1b")
    ...
    args = TrainingArguments(
        f"/data/datasets/hf_cache/out/{args.model_name}/fineweb/sample-350BT/{args.ckpt}-data_influence_model-flan",
