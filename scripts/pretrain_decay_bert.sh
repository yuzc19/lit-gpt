...
#SBATCH --job-name=pretrain_decay_bert
...
# sbatch scripts/pretrain_decay_bert.sh

export NCCL_P2P_DISABLE=1

method=top_bert
data_path=/data/datasets/hf_cache/data/fineweb/sample-350BT/train/0/select_bert_top_decay
