...
#SBATCH --job-name=pretrain_decay_bert_mab
...
# sbatch scripts/pretrain_decay_bert_mab.sh

export NCCL_P2P_DISABLE=1

method=mab_bert
data_path=/data/datasets/hf_cache/data/fineweb/sample-350BT/train/0/select_bert_mab_decay
