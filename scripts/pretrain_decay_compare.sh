...
#SBATCH --job-name=pretrain_decay_compare
...
# sbatch scripts/pretrain_decay_compare.sh

export NCCL_P2P_DISABLE=1

method=bge_cluster_gradsim
data_path=/data/datasets/hf_cache/data/fineweb/sample-350BT/train/0/select_grad_sim_cluster_decay
...
method2=top_gradsim
data_path2=/data/datasets/hf_cache/data/fineweb/sample-350BT/train/0/select_grad_sim_top_decay
